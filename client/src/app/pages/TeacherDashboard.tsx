        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
            <div>
              ...
              <p className="text-gray-600">{t('teacherDash.subtitle')}</p>
            </div>
            ...
            <>
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-8">
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">{t('teacherDash.manageStudentsDesc')}</p>
                </Link>
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">{t('teacherDash.viewAnalyticsDesc')}</p>
                </Link>
